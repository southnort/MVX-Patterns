...
namespace MVVM
{
    ...
    public class ViewModel : MonoBehaviour
    {
        ...
        public IEnumerable<IBindable> GetProperties()
        {
            ...
            {
                if (_properties.TryGetValue(property, out var propertyInfo))
                {
                ...
                propertyInfo = new Property(this, property.GetValue, property.Name);

                AddPropertyChangeEventListener(GetModels(), property, propertyInfo.OnChanged);

                _properties.Add(property, propertyInfo);
                yield return propertyInfo;
            }
        }
